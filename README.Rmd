...
We use the R dataset created by Allison Horst called "palmerpenguins" for these examples, which we load below; we also create a few sequential categorical variables (for Bill Depth and Flipper Length) to use in our examples. 
